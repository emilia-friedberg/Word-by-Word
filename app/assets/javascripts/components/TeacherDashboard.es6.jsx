class TeacherDashboard extends React.Component {
  ...
  render () {
    ...
    <div className="container">
      ...
      { this.state.addAssignmentButtonVisible ?
        <button type="button" onClick={this.toggleAddAssignmentForm}>Add A New Assignment</button>
        : null
      }
      ...
      { this.state.addCohortOptionVisible ?
        <div className="add-cohort-option-div">
          <button type="button" onClick={this.toggleAddExistingCohortForm}>Existing Cohort</button>
          <button type="button" onClick={this.toggleAddNewCohortForm}>Create New Cohort</button>
        </div>
        : null
      }
